...
def set_payoffs(group: Group):
    ...
    playerDF['profit']=playerDF.price*playerDF.demand-playerDF.quality-playerDF.informalSignals-playerDF.formalSignals*10
...
class Results(Page):
    ...
    def is_displayed(player: Player):
        ...
        if subsession.round_number>3:
            return True
page_sequence = [PIntroduction, PDecide, PPrice, PResult, Introduction, Decide, Price, ResultsWaitPage, Results]